  ...
  build: {
    ...
    rollupOptions:  {
      ...
      input: {
        ...
        "display-list": resolve(__dirname, 'samples/display-list/index.html'),
        "display-grid": resolve(__dirname, 'samples/display-grid/index.html'),
        "virtual-scroll": resolve(__dirname, 'samples/virtual-scroll/index.html'),
